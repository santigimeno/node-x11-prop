...
exports.encode = function(type, data, null_terminated) {
    ...
    switch (type) {
        ...
        case "WM_HINTS":
        	result = Buffer.alloc(36);
        	result.writeUInt32LE(data.flags,0);
        	result.writeUInt32LE(data.input,4);
        	result.writeUInt32LE(data.initialState,8);
        	result.writeUInt32LE(data.iconPixmap,12);
        	result.writeUInt32LE(data.iconWindow,16);
        	result.writeUInt32LE(data.icon[0],20);
        	result.writeUInt32LE(data.icon[1],24);
        	result.writeUInt32LE(data.iconMask,28);
        	result.writeUInt32LE(data.windowGroup,32);
        	break;
